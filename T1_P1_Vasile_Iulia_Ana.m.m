...
%fs = 5000;
%vom realiza un vector de la 0 la 100 cu pasul 0.2 (rezolutie 200 ms)
t = 0 : 0.2 : 100;
...
subplot(3, 1, 1)
plot(t, x) %se afiseaza primul grafic
...
%formam un vector de la 0 la 100 folosind pasul 0.02 (rezolutie 20 ms)
t2 = 0 : 0.02 : 100;
...
subplot(3, 1, 2) 
plot(t2, x2) %se afiseaza  graficului nr. 2
axis([0 5.2 -1.2 1.2])
xlabel('Timp (sec)') %denumim axa X
ylabel('Amplitude') %denumim axa Y
